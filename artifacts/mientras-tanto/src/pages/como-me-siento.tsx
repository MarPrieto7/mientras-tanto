...
// Organic SVG blob shapes — one per emotion
const blobs: Record<NonNullable<EmotionState>, string> = {
  ...
  confundido: "M41.3,-52.5C54.4,-42.6,66.6,-31,71.8,-16.3C77.1,-1.5,75.4,16.4,67.6,31.1C59.8,45.8,45.8,57.3,30.1,64.7C14.4,72,-3,75.2,-18.8,70.2C-34.6,65.2,-48.8,52,-59.4,36.2C-70,20.3,-77,1.9,-74.4,-15C-71.7,-31.9,-59.3,-47.4,-44.6,-57.1C-29.9,-66.9,-12.9,-70.8,0.9,-71.8C14.7,-72.8,28.2,-62.4,41.3,-52.5Z",
