      ...
      <div className="flex flex-col w-full max-w-md mx-auto">
        <AnimatePresence mode="wait">
          {!selectedRitual ? (
            ...
            >
              <h2 className="text-3xl font-serif text-center mb-8 text-foreground">Pequeñas pausas</h2>
              {rituals.map((ritual) => (
                <button
                  key={ritual.id}
                ...
                >
                  <h3 className="text-lg font-serif text-foreground mb-2 group-hover:text-foreground transition-colors">{ritual.title}</h3>
            ...
            >
              ...
              <h2 className="text-2xl font-serif text-foreground mb-4">{selectedRitual.title}</h2>
              <p className="text-foreground-soft text-center text-sm mb-12 max-w-xs">{selectedRitual.description}</p>
